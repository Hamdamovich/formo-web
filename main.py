...
def main(page: ft.Page):
    ...
    def route_change(route_event):
        try:
            ...
            # --- MIJOZ PROFILI (CLIENT CARD) ---
            elif page.route == "/client_card" or page.route == "/profile":
                user_data = {
            ...
            # --- TO'LOVLAR TARIXI ---
            elif page.route == "/payments_history" or page.route == "/history":
                page.views.append(
            ...
            # --- MIJOZ QR KODI (Barcha ma'lumotlar bilan) ---
                ...
                page.views.append(
                    ft.View(
                        "/client_qr", 
                        controls=[ft.SafeArea(ClientQRView(page, qr_user_data), expand=True)], 
                        padding=0, 
                        bgcolor=current_bg
                    )
                )
            ...
            # --- ALOQA (CALL CENTER) ---
                ...
                page.views.append(
                    ft.View(
                        "/call_center",
                        controls=[ft.SafeArea(CallCenterView(page), expand=True)],
                        padding=0,
                        bgcolor=current_bg
                    )
                )
